...
export const INIT_PRODUCTS: string = "INIT_PRODUCTS";
...
export function listProducts(products: IProduct[]): IListProductsActionType {
    return { type: INIT_PRODUCTS, product: products };
}
...
interface IListProductsActionType { type: string, product: IProduct[] };
