...
const Orders: React.FC = () => {
    ...
    return (
        <Fragment>
            <h1 className="h3 mb-2 text-gray-800">Pedido</h1>
            <p className="mb-4">Pedidos aqui</p>

            <div className="row">
                <TopCard title="TOTAL VENDAS" text={totalSales.toString()} icon="donate" class="primary" />
                <TopCard title="QTD TOTAL" text={totalAmount.toString()} icon="calculator" class="danger" />
            </div>
