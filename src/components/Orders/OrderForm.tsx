...
import { useState, FormEvent, Fragment, Dispatch } from "react";
        ...
        <Fragment>
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-green">Criar pedido</h6>
                </div>
                <div className="card-body">
                    <form onSubmit={saveOrder}>
                        ...
                        <button className="btn btn-danger" onClick={() => resetForm()}>Limpar</button>
                        <button type="submit" className={`btn btn-success left-margin ${getDisabledClass()}`}>Criar</button>
                    </form>
                </div>
            </div>
        </Fragment>
