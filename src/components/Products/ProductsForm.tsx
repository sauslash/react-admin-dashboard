...
import { useState, FormEvent, Dispatch, Fragment } from "react";
        ...
        <div className="card shadow mb-4">
          ...
          <div className="card-body">
            <form onSubmit={saveUser}>
              <div className="form-row">
                ...
                <div className="form-group col-md-6">
                  <SelectInput
                    ...
                    field="category"
                    label="Categoria"
                    options={["Frutas", "Folhas", "Legumes", "Carnes"]}
                    required={true}
                    onChange={hasFormValueChanged}
              ...
              <button type="submit" className={`btn btn-success left-margin ${getDisabledClass()}`}>Salvar</button>
            </form>
          </div>
        </div>
      </div>
